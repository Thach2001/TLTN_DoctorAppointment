...
const UpdateDoctor = ({ idDoctor, closePopupUpdate, loadListDoctor }) => {
   ...
   useEffect(() => {
      const getSingleDoctor = async () => {
         try {
            const res = await axios.get(`/api/doctors/${idDoctor}`);
   ...
   const handleUpdateDoctor = async (e) => {
      ...
      try {
         const res = await axios.put(`api/doctors/${idDoctor}`, formData);
